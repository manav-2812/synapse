...
- [2026-07-14] refactor(badges): use observer pattern for badge event dispatch
- [2026-07-14] chore: set up Playwright E2E test suite scaffolding
- [2026-07-15] chore: configure Oxlint rules for stricter code quality
- [2026-07-15] docs: create CHANGELOG entry for v1.2.0 milestone
- [2026-07-15] test(search): add unit tests for query sanitisation function
- [2026-07-17] perf(db): add composite index on user_progress table
- [2026-07-17] style(auth): polish login form error state animations
- [2026-07-17] ci: add coverage report upload step to CI pipeline
- [2026-07-18] fix(quiz): prevent double-submission on slow network connections
